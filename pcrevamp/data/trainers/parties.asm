...
; ================
	...
	db 21, MILTANK, LUM_BERRY, 48, ABIL_MILTANK_SCRAPPY | QUIRKY, FEMALE
...
; ================
	...
	db 75, MILTANK, BRIGHTPOWDER, ABIL_MILTANK_SCRAPPY | QUIRKY, FEMALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 24, HAUNTER, NO_ITEM, 64, ABIL_HAUNTER_LEVITATE | QUIRKY, MALE
...
if DEF(FAITHFUL)
	db 26, GENGAR, WIDE_LENS, 64, ABIL_GENGAR_CURSED_BODY | QUIRKY, MALE
else
	db 26, GENGAR, WIDE_LENS, 64, ABIL_GENGAR_LEVITATE | QUIRKY, MALE
endc
...
; ================
	...
	; party
if DEF(FAITHFUL)
	db 72, GENGAR, LEFTOVERS, ABIL_GENGAR_CURSED_BODY | QUIRKY, MALE
else
	db 72, GENGAR, LEFTOVERS, ABIL_GENGAR_LEVITATE | QUIRKY, MALE
endc
...
if DEF(FAITHFUL)
	db 74, HAUNTER, EVIOLITE, ABIL_HAUNTER_LEVITATE | QUIRKY, MALE
...
endc
if DEF(FAITHFUL)
	db 75, GENGAR, SPELL_TAG, ABIL_GENGAR_CURSED_BODY | QUIRKY, MALE
else
	db 75, GENGAR, SPELL_TAG, ABIL_GENGAR_LEVITATE | QUIRKY, MALE
endc
...
endc
	...
	db 47, KINGDRA, SHELL_BELL, 128, ABIL_KINGDRA_SNIPER | QUIRKY, FEMALE
...
; ================
	...
	db 74, EXEGGUTOR, LUM_BERRY, ABIL_EXEGGUTOR_HARVEST | QUIRKY, FEMALE
...
endc
	...
	db 75, KINGDRA, CHESTO_BERRY, ABIL_KINGDRA_SNIPER | QUIRKY, FEMALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 53, UMBREON, LEFTOVERS, 192, ABILITY_1 | QUIRKY, FEMALE
		db MUD_SLAP, CONFUSE_RAY, FEINT_ATTACK, MEAN_LOOK
	db 53, PERSIAN, PINK_BOW, 192, ABILITY_1 | QUIRKY, FEMALE | ALOLAN_FORM
	...
	db 55, GENGAR, SPELL_TAG, 192, ABILITY_1 | QUIRKY, FEMALE
		db SHADOW_BALL, WILL_O_WISP, CURSE, DESTINY_BOND
	db 55, HONCHKROW, BLACKGLASSES, 192, ABILITY_1 | QUIRKY, FEMALE
		db DRILL_PECK, SUCKER_PUNCH, PURSUIT, BRAVE_BIRD
	db 57, HOUNDOOM, CHARCOAL, 192, ABILITY_1 | QUIRKY, FEMALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 57, GYARADOS, MUSCLE_BAND, 208, ABIL_GYARADOS_INTIMIDATE | JOLLY, MALE
		db DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
	db 58, DRAGONITE, WIDE_LENS, 208, ABIL_DRAGONITE_MULTISCALE | MODEST, MALE
		db FIRE_BLAST, BLIZZARD, THUNDER, HYPER_BEAM
	db 58, KINGDRA, SCOPE_LENS, 208, ABIL_KINGDRA_SNIPER | MODEST, MALE
		db FOCUS_ENERGY, DRAGON_PULSE, SURF, HYPER_BEAM
	db 57, AERODACTYL, KINGS_ROCK, 208, ABIL_AERODACTYL_TOUGH_CLAWS | ADAMANT, MALE
		db AERIAL_ACE, ANCIENTPOWER, ROCK_SLIDE, GIGA_IMPACT
	db 57, CHARIZARD, WISE_GLASSES, 208, ABIL_CHARIZARD_SOLAR_POWER | MODEST, MALE
if DEF(FAITHFUL)
		db FLAMETHROWER, HYPER_BEAM, FOCUS_BLAST, AIR_SLASH
else
		db FLAMETHROWER, HYPER_BEAM, FOCUS_BLAST, DRAGON_PULSE
endc
	db 60, DRAGONITE, LEFTOVERS, 208, SHINY_MASK | ABIL_DRAGONITE_MULTISCALE | ADAMANT, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 75, GYARADOS, LIFE_ORB, ABILITY_1 | JOLLY, MALE
		db DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
	db 77, DRAGONITE, LEFTOVERS, ABIL_DRAGONITE_MULTISCALE | MODEST, MALE
	...
	db 76, AERODACTYL, CHOICE_BAND, ABIL_AERODACTYL_TOUGH_CLAWS | ADAMANT, MALE
		db STONE_EDGE, BRAVE_BIRD, IRON_HEAD, CRUNCH
if DEF(FAITHFUL)
	db 75, CHARIZARD, LIFE_ORB, ABIL_CHARIZARD_DROUGHT | MODEST, MALE
		db FIRE_BLAST, SOLAR_BEAM, FOCUS_BLAST, AIR_SLASH
else
	db 75, CHARIZARD, LIFE_ORB, ABIL_CHARIZARD_TOUGH_CLAWS | ADAMANT, MALE
		db DRAGON_DANCE, OUTRAGE, FLARE_BLITZ, ROOST
endc
	db 80, DRAGONITE, WEAK_POLICY, SHINY_MASK | ABIL_DRAGONITE_MULTISCALE | ADAMANT, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 90, PIKACHU, LIGHT_BALL, ABIL_PIKACHU_STATIC | NAIVE, MALE | PIKACHU_RED_FORM
		db THUNDERBOLT, SURF, IRON_TAIL, WILD_CHARGE
	db 84, ESPEON, TWISTEDSPOON, ABIL_ESPEON_MAGIC_BOUNCE | MODEST, MALE
		db PSYCHIC_M, HEALINGLIGHT, REFLECT, SHADOW_BALL
	db 85, SNORLAX, LEFTOVERS, ABIL_SNORLAX_IMMUNITY | ADAMANT, MALE
		db CURSE, REST, SLEEP_TALK, GYRO_BALL
	db 87, OMASTAR, WISE_GLASSES, ABIL_OMASTAR_SHELL_ARMOR | MODEST, MALE
		db SURF, ANCIENTPOWER, EARTH_POWER, ICE_BEAM
	db 87, GYARADOS, QUICK_CLAW, SHINY_MASK | ABIL_GYARADOS_MOXIE | ADAMANT, MALE
		db DRAGON_DANCE, WATERFALL, EARTHQUAKE, CRUNCH
if DEF(FAITHFUL)
	db 88, CHARIZARD, MUSCLE_BAND, ABIL_CHARIZARD_DROUGHT | ADAMANT, MALE
		db FLARE_BLITZ, SWORDS_DANCE, EARTHQUAKE, AERIAL_ACE
else
	db 88, CHARIZARD, MUSCLE_BAND, ABIL_CHARIZARD_TOUGH_CLAWS | ADAMANT, MALE
...
; ================
	...
	; party
	db 96, LAPRAS, LEFTOVERS, FAKE_PERFECT_DVS, ABIL_LAPRAS_SHELL_ARMOR | MODEST, FEMALE
		db ICE_BEAM, THUNDERBOLT, REST, SLEEP_TALK
	db 100, VENUSAUR, MIRACLE_SEED, FAKE_PERFECT_DVS, ABIL_VENUSAUR_THICK_FAT | HASTY, FEMALE
		db GROWTH, GIGA_DRAIN, SLUDGE_BOMB, SLEEP_POWDER
	db 98, MOLTRES, CHARCOAL, DVS_HP_GRASS, ABIL_MOLTRES_FLAME_BODY | MODEST, FEMALE
		db FIRE_BLAST, AIR_SLASH, HIDDEN_POWER, EXTRASENSORY
	db 95, SYLVEON, BRIGHTPOWDER, FAKE_PERFECT_DVS, ABIL_SYLVEON_PIXILATE | MODEST, FEMALE
		db MOONBLAST, LIGHT_SCREEN, CALM_MIND, HYPER_VOICE
	db 98, AERODACTYL, MUSCLE_BAND, FAKE_PERFECT_DVS, ABIL_AERODACTYL_TOUGH_CLAWS | ADAMANT, FEMALE
		db HONE_CLAWS, CRUNCH, EARTHQUAKE, ROCK_SLIDE
if DEF(FAITHFUL)
	db 99, MEW, WISE_GLASSES, FAKE_PERFECT_DVS, ABIL_MEW_SYNCHRONIZE | MODEST, FEMALE
		db NASTY_PLOT, PSYCHIC_M, AURA_SPHERE, ICE_BEAM
else
	db 99, MEW, WISE_GLASSES, FAKE_PERFECT_DVS, ABIL_MEW_MAGIC_GUARD | MODEST, FEMALE
		db NASTY_PLOT, PSYCHIC_M, AURA_SPHERE, ICE_BEAM
endc
	db -1 ; end
...
; ================
	...
	; party
	db 5, RATTATA, FAKE_PERFECT_DVS, ABIL_RATTATA_GUTS | ADAMANT, MALE
	db -1 ; end
...
; ================
	...
	; party
	db 15, RATTATA, ORAN_BERRY, 48, FAKE_PERFECT_DVS, ABIL_RATTATA_GUTS | ADAMANT, MALE
	db -1 ; end
...
; ================
	...
	; party
	db 25, RATICATE, ORAN_BERRY, 80, FAKE_PERFECT_DVS, ABIL_RATICATE_GUTS | ADAMANT, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 30, RATICATE, SITRUS_BERRY, 112, FAKE_PERFECT_DVS, ABIL_RATICATE_GUTS | ADAMANT, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 40, RATICATE, SITRUS_BERRY, 160, FAKE_PERFECT_DVS, ABIL_RATICATE_GUTS | ADAMANT, MALE
...
; ================
	...
	; party
	db 60, MARILL, EVIOLITE, ABIL_MARILL_HUGE_POWER | QUIRKY, FEMALE
	db 63, AZUMARILL, LEFTOVERS, ABIL_AZUMARILL_HUGE_POWER | QUIRKY, FEMALE
	db 60, MARILL, BLACK_BELT, ABIL_MARILL_HUGE_POWER | QUIRKY, FEMALE
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 16, TOGETIC, KINGS_ROCK, $EE, $EE, $EE, ABIL_TOGETIC_SERENE_GRACE | QUIRKY, MALE
		db HEADBUTT, METRONOME, SWEET_KISS, DISARM_VOICE
	db 16, CHANSEY, KINGS_ROCK, $EE, $EE, $EE, ABIL_CHANSEY_SERENE_GRACE | QUIRKY, MALE
		db HEADBUTT, FRESH_SNACK, SWEET_KISS, ZEN_HEADBUTT
if DEF(FAITHFUL)
	db 17, SYLVEON, KINGS_ROCK, $EE, $EE, $EE, ABIL_SYLVEON_CUTE_CHARM | QUIRKY, FEMALE
else
	db 17, SYLVEON, KINGS_ROCK, $EE, $EE, $EE, ABIL_SYLVEON_SERENE_GRACE | QUIRKY, FEMALE
endc
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 25, MILTANK, LEFTOVERS, FAKE_PERFECT_DVS, ABIL_MILTANK_SCRAPPY | ADAMANT, FEMALE
		db DEFENSE_CURL, ROLLOUT, FRESH_SNACK, BODY_SLAM
	db 25, TAUROS, LEFTOVERS, FAKE_PERFECT_DVS, ABIL_TAUROS_ANGER_POINT | ADAMANT, MALE
...
; ================
	...
	db TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 57, AZUMARILL, ABIL_AZUMARILL_HUGE_POWER | ADAMANT, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 28, PRIMEAPE, PROTECT_PADS, FAKE_PERFECT_DVS, ABIL_PRIMEAPE_DEFIANT | ADAMANT, FEMALE
		db CROSS_CHOP, GUNK_SHOT, BULK_UP, NIGHT_SLASH
	db 30, URSARING, PROTECT_PADS, FAKE_PERFECT_DVS, ABIL_URSARING_UNNERVE | ADAMANT, MALE
...
; ================
	...
	db 43, DRAGONITE, FOCUS_SASH, 132, ABIL_DRAGONITE_MULTISCALE | ADAMANT, MALE
		db FOCUS_ENERGY, DRAGON_CLAW, EARTHQUAKE, ICE_PUNCH
	db 43, KINGDRA, FOCUS_SASH, 132, ABIL_KINGDRA_SNIPER | MODEST, MALE
		db DOUBLE_TEAM, DRAGON_PULSE, SURF, ICE_BEAM
	db 43, CHARIZARD, FOCUS_SASH, 132, ABIL_CHARIZARD_FLASH_FIRE | ADAMANT, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 32, ALAKAZAM, FLAME_ORB, 84, FAKE_PERFECT_DVS, ABIL_ALAKAZAM_SYNCHRONIZE | MODEST, FEMALE
		db LIGHT_SCREEN, REFLECT, PSYCHIC_M, SHADOW_BALL
	db 32, MACHAMP, FLAME_ORB, 84, FAKE_PERFECT_DVS, ABIL_MACHAMP_GUTS | ADAMANT, FEMALE
		db FACADE, MACH_PUNCH, BULLET_PUNCH, ICE_PUNCH
	db 32, JOLTEON, FLAME_ORB, 84, DVS_HP_ICE, ABIL_JOLTEON_QUICK_FEET | MODEST, FEMALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 8, GEODUDE, AIR_BALLOON, 12, $DD, $DD, $DD, ABIL_GEODUDE_STURDY | RELAXED, MALE
		db TACKLE, DEFENSE_CURL, MUD_SLAP, ROLLOUT
	db 9, MAREEP, AIR_BALLOON, 12, $DD, $DD, $DD, ABIL_MAREEP_STATIC | RASH, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 11, BELLSPROUT, MIRACLE_SEED, 20, $EE, $EE, $EE, ABIL_BELLSPROUT_CHLOROPHYLL | ADAMANT, MALE
		db VINE_WHIP, GROWTH, WRAP, SLEEP_POWDER
	db 11, ZUBAT, MIRACLE_SEED, 20, $EE, $EE, $EE, ABIL_ZUBAT_INNER_FOCUS | RASH, MALE
		db GUST, ABSORB, ASTONISH, BITE
	db 14, BULBASAUR, MIRACLE_SEED, 20, $EE, $EE, $EE, ABIL_BULBASAUR_CHLOROPHYLL | HASTY, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 20, WEEPINBELL, BINDING_BAND, 52, ABIL_WEEPINBELL_CHLOROPHYLL | HASTY, FEMALE
		db WRAP, SLEEP_POWDER, POISONPOWDER, STUN_SPORE
	db 20, AZUMARILL, BINDING_BAND, 52, ABIL_AZUMARILL_SAP_SIPPER | HASTY, FEMALE
		db WHIRLPOOL, PERISH_SONG, AQUA_TAIL, PROTECT
	db 21, CHARMELEON, BINDING_BAND, 52, ABIL_CHARMELEON_SOLAR_POWER | HASTY, FEMALE
...
if DEF(FAITHFUL)
	db 35, PUPITAR, ROCKY_HELMET, 116, ABIL_PUPITAR_SHED_SKIN | ADAMANT, MALE
else
	db 35, PUPITAR, ROCKY_HELMET, 116, ABIL_PUPITAR_BATTLE_ARMOR | ADAMANT, MALE
endc
		db SANDSTORM, ROCK_SLIDE, PURSUIT, OUTRAGE
	db 36, FORRETRESS, ROCKY_HELMET, 116, ABIL_FORRETRESS_STURDY | ADAMANT, MALE
		db SPIKES, EXPLOSION, SANDSTORM, DIG
	db 36, SKARMORY, ROCKY_HELMET, 116, ABIL_SKARMORY_STURDY | QUIRKY, MALE
		db SPIKES, ROAR, TOXIC, PROTECT
	db 37, UMBREON, ROCKY_HELMET, 116, ABIL_UMBREON_SYNCHRONIZE | QUIRKY, MALE
...
; ================
	...
	db 49, ALAKAZAM, CHOICE_SPECS, 148, DVS_HP_FIRE, ABIL_ALAKAZAM_TRACE | MODEST, FEMALE
		db PSYCHIC_M, SHADOW_BALL, FOCUS_BLAST, HIDDEN_POWER
	db 49, PORYGON_Z, CHOICE_SPECS, 148, DVS_HP_GROUND, ABIL_PORYGON_Z_ADAPTABILITY | MODEST, FEMALE
		db TRI_ATTACK, DARK_PULSE, ICE_BEAM, HIDDEN_POWER
if DEF(FAITHFUL)
	db 49, GENGAR, CHOICE_SPECS, 148, DVS_HP_ICE, ABIL_GENGAR_CURSED_BODY | MODEST, FEMALE
else
	db 49, GENGAR, CHOICE_SPECS, 148, DVS_HP_ICE, ABIL_GENGAR_LEVITATE | MODEST, FEMALE
endc
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 70, MEWTWO, ARMOR_SUIT, ABIL_MEWTWO_INSOMNIA | MODEST, MALE | MEWTWO_ARMORED_FORM, "?????@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 27, DROWZEE, EVIOLITE, FAKE_PERFECT_DVS, ABIL_DROWZEE_INSOMNIA | QUIRKY, MALE
		db DREAM_EATER, HYPNOSIS, DISABLE, PSYBEAM
	db 27, HAUNTER, SPELL_TAG, FAKE_PERFECT_DVS, ABIL_HAUNTER_LEVITATE | QUIRKY, MALE
		db SHADOW_BALL, HYPNOSIS, CONFUSE_RAY, CURSE
	db 28, ELECTRODE, MAGNET, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_ELECTRODE_AFTERMATH | QUIRKY, MALE
		db THUNDER, SCREECH, SONIC_BOOM, ROLLOUT
	db 29, ALAKAZAM, TWISTEDSPOON, DVS_HP_FIGHTING, ABIL_ALAKAZAM_SYNCHRONIZE | QUIRKY, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 65, EXEGGUTOR, FIGY_BERRY, DVS_HP_FIRE, MODEST | ABIL_EXEGGUTOR_HARVEST, MALE
		db PSYCHIC_M, SUNNY_DAY, HIDDEN_POWER, SOLAR_BEAM
	db 65, WEAVILE, NO_ITEM, FAKE_PERFECT_DVS, ADAMANT | ABIL_WEAVILE_PICKPOCKET, FEMALE
		db NIGHT_SLASH, ICE_PUNCH, SLASH, SWORDS_DANCE
	db 65, PARASECT, KINGS_ROCK, FAKE_PERFECT_DVS, ADAMANT | ABIL_PARASECT_EFFECT_SPORE, MALE
if DEF(FAITHFUL)
		db LEECH_LIFE, SEED_BOMB, SLUDGE_BOMB, SLASH
else
		db LEECH_LIFE, SEED_BOMB, SLUDGE_BOMB, CUT
endc
	db 65, PORYGON2, EVIOLITE, FAKE_PERFECT_DVS, BOLD | ABIL_PORYGON2_DOWNLOAD, MALE
		db RECOVER, TRI_ATTACK, THUNDER_WAVE, SHADOW_BALL
	db 65, SNORLAX, LEFTOVERS, FAKE_PERFECT_DVS, ADAMANT | ABIL_SNORLAX_IMMUNITY, MALE
		db CURSE, REST, SLEEP_TALK, RETURN
if DEF(FAITHFUL)
	db 65, JYNX, WIDE_LENS, FAKE_PERFECT_DVS, MODEST | ABIL_JYNX_OBLIVIOUS, FEMALE
else
	db 65, JYNX, WIDE_LENS, FAKE_PERFECT_DVS, MODEST | ABIL_JYNX_FILTER, FEMALE
endc
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 69, PIKACHU, LIGHT_BALL, ABIL_PIKACHU_STATIC | MODEST, MALE, "Puka@"
...
; ================
	...
	; party
	db 41, RATTATA, SITRUS_BERRY, 120, ABIL_RATTATA_GUTS | ADAMANT, FEMALE, "Ratty@"
		db SUCKER_PUNCH, QUICK_ATTACK, HYPER_FANG, SWORDS_DANCE
	db 39, BUTTERFREE, SITRUS_BERRY, 120, ABIL_BUTTERFREE_TINTED_LENS | MODEST, FEMALE, "Kitty@"
		db BUG_BUZZ, SUPERSONIC, STUN_SPORE, PSYCHIC_M
	db 42, DODUO, NO_ITEM, 120, ABIL_DODUO_TANGLED_FEET | HASTY, FEMALE, "Dody@"
		db SWORDS_DANCE, ACROBATICS, RETURN, MUD_SLAP
	db 41, GRAVELER, EVIOLITE, 120, ABIL_GRAVELER_STURDY | ADAMANT, FEMALE, "Gravvy@"
		db ROLLOUT, DEFENSE_CURL, EARTHQUAKE, ROCK_BLAST
	db 40, OMANYTE, SITRUS_BERRY, 120, ABIL_OMANYTE_SHELL_ARMOR | QUIRKY, FEMALE, "Omny@"
		db SURF, PROTECT, ANCIENTPOWER, AURORA_BEAM
	db 44, PIKACHU, LIGHT_BALL, 120, ABIL_PIKACHU_STATIC | HASTY, FEMALE | PIKACHU_YELLOW_FORM, "Chuchu@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 72, OMASTAR, WISE_GLASSES, ABIL_OMASTAR_SHELL_ARMOR | QUIRKY, FEMALE, "Omny@"
		db SCALD, ANCIENTPOWER, SPIKES, ICE_BEAM
	db 73, RATICATE, KINGS_ROCK, ABIL_RATICATE_GUTS | ADAMANT, FEMALE, "Ratty@"
		db SWORDS_DANCE, QUICK_ATTACK, SUPER_FANG, CRUNCH
	db 71, BUTTERFREE, BRIGHTPOWDER, ABIL_BUTTERFREE_TINTED_LENS | MODEST, FEMALE, "Free@"
		db PSYCHIC_M, BUG_BUZZ, SLEEP_POWDER, STUN_SPORE
	db 74, DODRIO, SHARP_BEAK, ABIL_DODUO_TANGLED_FEET | HASTY, FEMALE, "Dody@"
		db DRILL_PECK, TRI_ATTACK, DOUBLE_TEAM, PURSUIT
	db 73, GOLEM, MUSCLE_BAND, ABIL_GOLEM_STURDY | ADAMANT, FEMALE, "Gravvy@"
		db ROLLOUT, DEFENSE_CURL, EARTHQUAKE, STONE_EDGE
	db 75, PIKACHU, LIGHT_BALL, ABIL_PIKACHU_STATIC | HASTY, FEMALE | PIKACHU_YELLOW_FORM, "Chuchu@"
