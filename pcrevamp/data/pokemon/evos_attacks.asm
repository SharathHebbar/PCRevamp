...
CharmanderEvosAttacks:
	db EVOLVE_LEVEL, 24, CHARMELEON
	db 0 ; no more evolutions
	db 1, SCRATCH
	db 1, GROWL
	db 7, EMBER
	db 10, SMOKESCREEN
	db 15, METAL_CLAW ; Dragon Rage → TM move
...
ButterfreeEvosAttacks:
	...
	db 14, POISONPOWDER
	db 16, STUN_SPORE
	db 18, SLEEP_POWDER ; Psybeam → Sleep Powder
	db 20, PSYBEAM ; Silver Wind → Psybeam
	db 23, SUPERSONIC
	db 25, SAFEGUARD
...
RattataAlolanEvosAttacks:
	...
	db 31, SUPER_FANG
	db 34, DOUBLE_EDGE
	db 38, COUNTER ; Endeavor → egg move
	db 0 ; no more level-up moves
...
RaticateAlolanEvosAttacks:
	...
	db 39, DOUBLE_EDGE
	db 44, FIRE_PUNCH
	db 48, COUNTER ; Endeavor → egg move
	db 0 ; no more level-up moves
...
SandshrewAlolanEvosAttacks:
	...
	db 26, ROLLOUT ; Iron Defense → TM move
	db 29, ICE_PUNCH
	db 32, SLASH
	db 35, IRON_HEAD
	db 38, GYRO_BALL
...
ClefableEvosAttacks:
	...
	db 1, EXTRASENSORY
	db 1, MOONBLAST ; Let's Go TM move
	db 1, SING
	db 1, MINIMIZE
	db 1, METRONOME
	db 1, DOUBLE_SLAP
...
VulpixPlainEvosAttacks:
	...
	db 1, EMBER
	db 1, GROWL ; Tail Whip → new move
	db 5, ASTONISH ; Roar → new move
	db 7, CHARM ; Baby-Doll Eyes → similar move
	db 10, QUICK_ATTACK
	db 12, CONFUSE_RAY
	db 15, FIRE_SPIN
...
BellsproutEvosAttacks:
	...
	db 50, LEECH_LIFE
	db 53, SWORDS_DANCE ; Wring Out → egg move
	db 0 ; no more level-up moves
...
WeepinbellEvosAttacks:
	...
	db 58, LEECH_LIFE
	db 62, SWORDS_DANCE ; Wring Out → egg move
	db 0 ; no more level-up moves
...
VictreebelEvosAttacks:
	...
	db 44, LEECH_LIFE
	db 58, SWORDS_DANCE ; Leaf Blade → prior move
	db 0 ; no more level-up moves
...
MarowakAlolanEvosAttacks:
	...
	db 48, SACRED_FIRE
	db 53, ROCK_SMASH ; Endeavor → TM move
	db 57, FLARE_BLITZ
	db 61, PAIN_SPLIT ; Retaliate → S/M tutor move
	db 65, OUTRAGE ; Bone Rush → HGSS tutor move
	db 0 ; no more level-up moves
...
WeezingGalarianEvosAttacks:
	...
	db 29, GYRO_BALL
	db 34, SLUDGE_BOMB ; Sludge Bomb → Sw/Sh TR move
	db 40, EXPLOSION
	db 46, DESTINY_BOND
	db 51, PAIN_SPLIT ; Belch → HGSS tutor move
...
TogepiEvosAttacks:
	...
	db 53, MOONBLAST ; After You → Sw/Sh move
	db 0 ; no more level-up moves
...
BayleefEvosAttacks:
	...
	db 47, EARTH_POWER 
	db 51, SOLAR_BEAM
	db 54, MOONBLAST ; new move
	db 58, OUTRAGE ; HGSS tutor move
	db 64, HEAL_BELL ; Aromatherapy → similar move
	db 0 ; no more level-up moves
...
MeganiumEvosAttacks:
	...
	db 56, BODY_SLAM 
	db 62, SOLAR_BEAM
	db 66, MOONBLAST ; new move
	db 72, OUTRAGE ; HGSS tutor move
	db 80, HEAL_BELL ; Aromatherapy → similar move
	db 0 ; no more level-up moves

CyndaquilEvosAttacks:
	db EVOLVE_LEVEL, 24, QUILAVA
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, LEER
	db 6, SMOKESCREEN
...
NatuEvosAttacks:
	...
	db 39, AIR_SLASH ; Psycho Shift → egg move
	db 44, FUTURE_SIGHT
...
XatuEvosAttacks:
	...
	db 43, AIR_SLASH ; Psycho Shift → egg move
	db 49, FUTURE_SIGHT
...
SylveonEvosAttacks:
	...
	db 37, MOONBLAST
	db 41, DOUBLE_EDGE ; Last Resort → tutor move
	db 45, PSYCHIC_M ; Psych Up → new move
	db 0 ; no more level-up moves
