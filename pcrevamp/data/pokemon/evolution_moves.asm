EvolutionMoves::
	...
	db MEGA_DRAIN   ; IVYSAUR
	db PETAL_DANCE  ; VENUSAUR
	db NO_MOVE      ; CHARMANDER
	db SWORDS_DANCE ; CHARMELEON
	db WING_ATTACK  ; CHARIZARD
	db NO_MOVE      ; SQUIRTLE
	db AURORA_BEAM  ; WARTORTLE
	...
	db U_TURN       ; BEEDRILL
	db NO_MOVE      ; PIDGEY
	db DOUBLE_TEAM  ; PIDGEOTTO
	db EXTREMESPEED ; PIDGEOT
	db NO_MOVE      ; RATTATA
	db FLAME_CHARGE ; RATICATE
	db NO_MOVE      ; MARILL
