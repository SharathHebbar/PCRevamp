if DEF(FAITHFUL)
	db  78,  84,  88, 100, 115,  85 ; 550 BST
	;   hp  atk  def  spd  sat  sdf
else
	db  78,  110,  78, 100,  99,  85 ; 550 BST
	;   hp  atk  def  spd  sat  sdf
endc
...
if DEF(FAITHFUL)
	abilities_for CHARIZARD, FLASH_FIRE, SOLAR_POWER, DROUGHT
else
	abilities_for CHARIZARD, FLASH_FIRE, SOLAR_POWER, TOUGH_CLAWS
endc
